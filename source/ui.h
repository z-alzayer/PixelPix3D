...
#define SHOOT_CANCEL_X   94
#define SHOOT_CANCEL_W   82
#define SHOOT_PREVIEW_PRIMARY_X 182
#define SHOOT_PREVIEW_PRIMARY_W 132
...
#define SHOOT_STEREO_OUT_X  132
#define SHOOT_STEREO_OUT_Y  (SHOOT_BACK_Y + 2)
#define SHOOT_STEREO_OUT_W   70
